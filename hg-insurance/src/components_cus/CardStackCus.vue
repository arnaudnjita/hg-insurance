<template>
  ...
  >
    <div class="card-l" v-for="(a, idx) in infos" :key="idx">
      <h1 class="card-n" v-show="a.title == 'Insurance Active'">
        <span>.</span>{{ activeinsurance }}
      </h1>

      <h1 class="card-n" v-show="a.title == 'Insurance Expired'">
        <span>.</span>{{ expiredinsurance }}
      </h1>
      ...
      infos: [
        {
          ...
          image: "https://img.icons8.com/color/80/000000/get-cash.png",
          color: "blue",
        },
        {
          title: "Insurance Expired",
          image: "https://img.icons8.com/color/70/000000/expired.png",
          color: "red",
        },
      ],
    };
